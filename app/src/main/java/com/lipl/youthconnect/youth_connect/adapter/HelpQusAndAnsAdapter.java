 ...
 */
public class HelpQusAndAnsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public HelpQusAndAnsAdapter(Context context, List<ShowcaseEvent> showcaseEventList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(context).inflate(R.layout.help_q_n_a_list_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        holder.mTvAnswer.setTag(position);
        ...
        holder.mTvAnswer.setTypeface(Typeface.createFromAsset(context.getAssets(), Constants.ROBOTO_LIGHT));
        ...
        if(showcaseEvent != null) {
            ...
            holder.mTvAnswer.setText(showcaseEvent.getName());
        }
    }
