...
import com.lipl.youthconnect.youth_connect.adapter.NotificationAdapter;
 ...
 */
public class SendFeedbackFragment extends Fragment implements AbsListView.OnItemClickListener,
        SendFeedbackAdapter.OnActivityItemClickListener {
     ...
     * Views.
     */
    private SendFeedbackAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<ShowcaseEvent> showcaseEventList = new ArrayList<ShowcaseEvent>();
        ShowcaseEvent showcaseEvent1 = new ShowcaseEvent(Parcel.obtain());
        showcaseEvent1.setName("Feedback 1");
        showcaseEvent1.setPhotosList(new ArrayList<String>());
        showcaseEvent1.setPhotosList(new ArrayList<String>());
        showcaseEventList.add(showcaseEvent1);

        ShowcaseEvent showcaseEvent2 = new ShowcaseEvent(Parcel.obtain());
        showcaseEvent2.setName("Feedback 2");
        showcaseEvent2.setPhotosList(new ArrayList<String>());
        showcaseEvent2.setPhotosList(new ArrayList<String>());
        showcaseEventList.add(showcaseEvent2);

        ShowcaseEvent showcaseEvent3 = new ShowcaseEvent(Parcel.obtain());
        showcaseEvent3.setName("Feedback 3");
        showcaseEvent3.setPhotosList(new ArrayList<String>());
        showcaseEvent3.setPhotosList(new ArrayList<String>());
        showcaseEventList.add(showcaseEvent3);

        ShowcaseEvent showcaseEvent4 = new ShowcaseEvent(Parcel.obtain());
        showcaseEvent4.setName("Feedback 4");
        showcaseEvent4.setPhotosList(new ArrayList<String>());
        showcaseEvent4.setPhotosList(new ArrayList<String>());
        showcaseEventList.add(showcaseEvent4);

        ShowcaseEvent showcaseEvent5 = new ShowcaseEvent(Parcel.obtain());
        showcaseEvent5.setName("Feedback 5");
        showcaseEvent5.setPhotosList(new ArrayList<String>());
        showcaseEvent5.setPhotosList(new ArrayList<String>());
        showcaseEventList.add(showcaseEvent5);

        mAdapter = new SendFeedbackAdapter(getActivity(), showcaseEventList);
        ...
        if(showcaseEventList != null && showcaseEventList.size() > 0){
