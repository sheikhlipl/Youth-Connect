...
public class ForumFragment extends Fragment implements
    ...
    private void setQuestionAnswerList(String filterText){
        ...
        if(ForumFragment.this.mListItems == null){
            ForumFragment.this.mListItems = new LinkedList<QuestionAndAnswer>();
        }
        ...
        adapter = new QADataAdapter(_questionAndAnswerList, getActivity(), true, false);
    ...
    public void onResume()
    {
        ...
        YouthConnectSingleTone.getInstance().currentFragmentOnMainActivity = Constants.FRAGMENT_QA_FORUM;
    }
}