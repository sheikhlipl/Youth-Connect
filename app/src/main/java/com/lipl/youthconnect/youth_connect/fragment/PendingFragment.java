...
public class PendingFragment extends Fragment implements
    ...
    private void setQuestionAnswerList(String filterText){
        ...
        if(PendingFragment.this.mListItems == null){
            PendingFragment.this.mListItems = new LinkedList<QuestionAndAnswer>();
        }
        ...
        adapter = new QADataAdapter(_questionAndAnswerList, getActivity(), false, false);
    ...
    public void onResume()
    {
        ...
        YouthConnectSingleTone.getInstance().currentFragmentOnMainActivity = Constants.FRAGMENT_QA_PENDING;
    }
}