 ...
 */
public class SendFeedbackAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public SendFeedbackAdapter(Context context, List<ShowcaseEvent> showcaseEventList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(context).inflate(R.layout.send_feedback_list_item, parent, false);
