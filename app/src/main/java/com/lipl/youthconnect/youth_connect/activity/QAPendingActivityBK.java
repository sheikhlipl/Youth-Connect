...
public class QAPendingActivityBK extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(QAPendingActivityBK.this, AskQuestionActivity.class));
            }
        });
    }
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                try {
                    if (questionAndAnswerList != null && questionAndAnswerList.size() > 0) {
                        ...
                        adapter = new QADataAdapter(mListItems, QAPendingActivityBK.this, false, false);
    ...
    private List<QuestionAndAnswer> getQAList() throws CouchbaseLiteException, IOException {
        ...
        if(ids != null && ids.size() > 0) {
            for (String id : ids) {
                Document document = DatabaseUtil.getDocumentFromDocumentId(DatabaseUtil.getDatabaseInstance(QAPendingActivityBK.this,
    ...
    private List<String> getAllDocumentIds(){
        ...
        try {
            Database database = DatabaseUtil.getDatabaseInstance(QAPendingActivityBK.this, Constants.YOUTH_CONNECT_DATABASE);
    ...
    private void setQuestionAnswerList(String filterText){
        ...
        if(QAPendingActivityBK.this.mListItems == null){
            QAPendingActivityBK.this.mListItems = new LinkedList<QuestionAndAnswer>();
        }
        ...
        adapter = new QADataAdapter(_questionAndAnswerList, QAPendingActivityBK.this, false, false);
