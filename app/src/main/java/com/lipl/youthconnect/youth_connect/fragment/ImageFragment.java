...
public class ImageFragment extends Fragment implements AbsListView.OnItemClickListener {
    ...
    private static final String ARG_POSITION = "campcode";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int position = 0;
        try {
            position = Integer.parseInt(mPosition);
        } catch(Exception e){
            Log.e("ImageFragment", "onCreateView()", e);
        }

        ImageView imgEvent = (ImageView) view.findViewById(R.id.imgEvent);
        //imgEvent.setImageResource(Constants.imageIDs[position]);
